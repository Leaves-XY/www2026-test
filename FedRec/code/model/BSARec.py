...
class BSARecBlock(nn.Module):
    def __init__(self, n_heads, hidden_size, inner_size, hidden_dropout_prob, attn_dropout_prob, hidden_act, layer_norm_eps, c, alpha):
        super(BSARecBlock, self).__init__()
        self.layer = BSARecLayer(n_heads, hidden_size, hidden_dropout_prob, attn_dropout_prob, layer_norm_eps, c, alpha)
...
class BSARecEncoder(nn.Module):
    def __init__(self, n_layers=2, n_heads=2, hidden_size=64, inner_size=256, hidden_dropout_prob=0.5, attn_dropout_prob=0.5, hidden_act="gelu", layer_norm_eps=1e-12, c=10, alpha=0.5):
        super(BSARecEncoder, self).__init__()
        block = BSARecBlock(n_heads, hidden_size, inner_size, hidden_dropout_prob, attn_dropout_prob, hidden_act, layer_norm_eps, c, alpha)
...
class BSARec(nn.Module):
    def __init__(self, config, item_maxid):
        ...
        self.encoder = BSARecEncoder(n_layers=self.n_layers, n_heads=self.n_heads, hidden_size=self.hidden_size, inner_size=self.inner_size, hidden_dropout_prob=self.hidden_dropout_prob, attn_dropout_prob=self.attn_dropout_prob, hidden_act=self.hidden_act, layer_norm_eps=self.layer_norm_eps, c=self.c, alpha=self.alpha,)
    ...
    def forward(self, x, x_lens):
        ...
        trm_output = self.encoder(input_emb, extended_attention_mask, output_all_encoded_layers=True)
        output = trm_output[-1]
    ...
    def log2feats ( self, log_seqs ):
        ...
        trm_output = self.encoder (seqs, extended_attention_mask, output_all_encoded_layers = True)
